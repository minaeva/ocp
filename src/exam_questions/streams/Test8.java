...
//                System.out.println(stream.reduce(0, Integer::multiply)); //not
        //        System.out.println(stream.reduce(1, Integer::multiply)); //not
        //        System.out.println(stream.reduce(res, (i, j) -> i * j)); //ok
        //        System.out.println(stream.reduce(0, (i, j) -> i * j)); //not
    }
}
